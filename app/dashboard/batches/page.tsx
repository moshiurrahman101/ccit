  ...
  const fetchBatches = async (page = 1, search = '', status = '') => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log('First batch mentor data:', data.batches[0]?.mentorId);
        console.log('Mentor data type:', typeof data.batches[0]?.mentorId);
        console.log('Mentor has _id:', !!data.batches[0]?.mentorId?._id);
                    ...
                    <div className="flex items-center">
                      {batch.mentorId ? (
                        ...
                        <>
                          ...
                          <div className="ml-3">
                            <div className="text-sm font-medium text-red-600">মেন্টর পাওয়া যায়নি</div>
                            <div className="text-sm text-gray-500">মেন্টর ডেটা অনুপলব্ধ</div>
                          </div>
                        </>
                      )}
                    </div>
