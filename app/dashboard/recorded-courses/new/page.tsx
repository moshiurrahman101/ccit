...
export default function NewRecordedCoursePage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        toast.success('Recorded course created successfully');
                ...
                <div className="mt-4 space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedMentors.map((mentor) => (
                      <Badge key={mentor._id} variant="secondary" className="flex items-center gap-2 py-1 px-3">
                        {mentor.avatar ? (
                          <img src={mentor.avatar} alt={mentor.name} className="w-5 h-5 rounded-full" />
                        ) : (
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">নতুন রেকর্ড করা কোর্স তৈরি করুন</h1>
              <p className="text-gray-600">ইউটিউব ভিডিও সহ প্রাক-রেকর্ড করা কোর্স তৈরি করুন</p>
            </div>
          </div>
